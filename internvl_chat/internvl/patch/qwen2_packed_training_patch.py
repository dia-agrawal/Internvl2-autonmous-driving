...
if _qwen2_mod is not None:
    QWEN2_ATTENTION_CLASSES = getattr(_qwen2_mod, "QWEN2_ATTENTION_CLASSES", None)
    Qwen2FlashAttention2 = getattr(_qwen2_mod, "Qwen2FlashAttention2", None)
...
if Qwen2FlashAttention2 is not None:
    ...
    def replace_qwen2_attention_class():
        if QWEN2_ATTENTION_CLASSES is None:
            print("QWEN2_ATTENTION_CLASSES not found in transformers; skipping QWEN2 packed training patch.")
            return
    ...
    def replace_qwen2_attention_class(*args, **kwargs):
        print("Transformers QWEN2 attention class not available; skipping QWEN2 packed training patch.")
